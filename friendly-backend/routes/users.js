...
router.post('/:uid/profile/picture', (req, res, next) => {
  ...
  try {
    ...
    if (existingProfile.profilePicture) {
      const oldPicturePath = path.join(__dirname, '../uploads/profiles', path.basename(existingProfile.profilePicture));
    ...
    // and get a public URL. For now, we'll use a relative path.
